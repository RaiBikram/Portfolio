...
export const ABOUT_TEXT = `As a MERN stack developer with experience in MongoDB, Express, React, Node.js, and Next.js, I’m passionate about building efficient, scalable web applications. Always eager to learn and explore new technologies, I strive to create innovative solutions. Let’s connect and build something impactful!`;
