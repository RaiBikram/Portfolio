...
export default function Navbar() {
  return (
    <div className="pt-6 w-full flex justify-center px-4">
      <nav className="w-full md:w-1/2 lg:w-1/2 max-w-xs flex items-center justify-evenly bg-green-900 h-12 rounded-full shadow-md text-base sm:text-base font-semibold">
        <NavLink
          to="/"
          className={({ isActive }) =>
